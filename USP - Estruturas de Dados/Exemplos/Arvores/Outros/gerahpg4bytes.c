...
{ Tipor v; TipoValorAresta A1;
  int Aux; short EncontrouAresta;
...
void GrafoAciclico (TipoGrafo* Grafo,
                    ...
                    short* GAciclico)
{ TipoValorVertice j; TipoValorAresta A1;  
  TipoItem x; TipoFila Fila; 
  TipoValorAresta NArestas; TipoAresta Aresta;
...
void ProxArestaInc(TipoValorVertice *Vertice, TipoGrafo *Grafo, 
  TipoValorAresta *Inc, TipoPesoAresta *Peso, TipoApontador *Prox, short *FimListaInc)
{
  *Inc = *Prox % Grafo->NumArestas; *Peso = Grafo->Arestas[*Inc].Peso;
  if (Grafo->Prox[*Prox] == INDEFINIDO) *FimListaInc = TRUE;
