# Criação de Bucket na AWS

## Contexto

Este repositório foi criado como conteúdo adicional para a aula [**Criação de Bucket na AWS**](https://www.udemy.com/course/terraform-do-basico-ao-avancado/learn/lecture/30183384#overview) do curso [**Terraform - Básico ao Avançado**](https://www.udemy.com/course/terraform-do-basico-ao-avancado/?couponCode=TERRAFORM_FEV24), por Daniel Gil.
